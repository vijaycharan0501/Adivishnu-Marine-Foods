...
const productSchema = new mongoose.Schema({
  ...
  quantity: { type: Number, required: function() { return !!this.farmer; } }, // In KG (for Farmer context)
  piecesPerKg: { type: String, required: function() { return !!this.farmer; } }, // e.g., '20-25'
